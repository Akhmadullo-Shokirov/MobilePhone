...
public class MobilePhone {
    ...
    public void addNewContact(String name, String phoneNumber) {
        ...
        Contacts resultLoop = loopContacts(name);
        if(resultLoop != null) {
            ...
            System.out.println("New contact created. Name: " + newContact.getName() + ", phone number: " + newContact.getPhoneNumber());
        }
    }

    public void updateContact(String contactName, String newPhoneNumber) {

        Contacts resultLoop = loopContacts(contactName);
        if(resultLoop != null) {
            resultLoop.setPhoneNumber(newPhoneNumber);
            System.out.println("Phone number updated for " + resultLoop.getName() + ". New phone number: " + resultLoop.getPhoneNumber());
        } else {
    ...
    private Contacts loopContacts(String name) {
        Iterator<Contacts> contactsIterator = contactsArrayList.iterator();
        while (contactsIterator.hasNext()) {
